...
def auto_migrate_db():
    ...
    user_columns = [
        ...
        ("pairs", "VARCHAR DEFAULT 'BTC/USDT,ETH/USDT,SOL/USDT'"),
        ...
        ("invest_percentage", "FLOAT DEFAULT 10.0"),
        ("invest_percentage_ranging", "FLOAT DEFAULT 10.0"),
        ("trailing_stop_activation", "FLOAT DEFAULT 2.5"),
        ("trailing_stop_distance", "FLOAT DEFAULT 0.55"),
